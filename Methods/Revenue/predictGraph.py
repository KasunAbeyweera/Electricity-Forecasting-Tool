...
data = pd.read_csv("C:\\Users\\kasun\\Downloads\\flaskProject\\Datasets\\Sales.csv")
def predictGraph():
    ...
    predicted_data = np.append(data["totalSales"].tail(12).values, actual_prediction[0][0])
    ...
    actual_data = data["totalSales"].tail(12)
